package com.country.servcie.mapper;
...
import com.country.servcie.enums.Status;
...
import com.country.servcie.response.CityResponse;
import com.country.servcie.response.CountryResponse;
import com.country.servcie.response.StateResponse;
...
public class CountryMapper {
    ...
    public static CountryResponse toCountryResponse( CountryModel model,  List<StateModel> models){
        return CountryResponse.builder()
                ...
                .states(modelToStatesResponse(models))
                .build();
    }
